...
public class WeightedIntrusiveEdgesSpecifics<V, E>
    ...
    public boolean add(E e, V sourceVertex, V targetVertex) {
        ...
        return putIfAbsent(e, intrusiveEdge) == null;
    }

    private IntrusiveWeightedEdge putIfAbsent(E e, IntrusiveWeightedEdge intrusiveEdge) {
        IntrusiveWeightedEdge edge = edgeMap.get(e);
        if (edge == null) {
            edge = edgeMap.put(e, intrusiveEdge);
        }
        return edge;
    }
